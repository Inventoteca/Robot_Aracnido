...
const char* ssid = "RobotAracnido";
const char* password = "12345678";

const int led = 13;
String lastComm = "";

//Aquí se crea el WebSocket y se pone en línea el server en sus respectivos puertos
WebSocketsServer webSocket = WebSocketsServer(81);
ESP8266WebServer server(80);

//Esta es la página web que se mostrará
...
<table width="100%" border="1">
  <tr>
    <td bgcolor="#FFFF33" id="JD">Spider Robot Control</td>
  </tr>
</table>
...
<p class="foot">Desarrollado para Spider Robot con ESP8266.</p>
</body>
</html>
)rawliteral";
...
void setup() {
  ...
  delay(500);
  Serial.println("Hola! Ya encendi");
  pinMode(LED_BUILTIN, OUTPUT); //Inicializa el led para salida
  ...
  WiFi.softAP(ssid, password);  //Se puede eliminar contraseña aquí
 
  IPAddress myIP = WiFi.softAPIP(); //Te dice la direccion IP a buscar si te conectas a su WiFi
  Serial.println("");
...
void webSocketEvent(uint8_t num, WStype_t type, uint8_t * payload, size_t length)
{
  switch(type) {
    ...
    case WStype_CONNECTED:
      ...
      break;
    case WStype_TEXT:
      Serial.printf("%s\r\n", payload); //<-------Aquí se mandan los comandos para indicar las acciones a realizar
