...
void loop() {
   digitalWrite(LED_BUILTIN, HIGH); //Encender led para ver que está listo
   
   if (Serial.available() > 0){ //Checar si está conectado algo por puerto serial
      char c[] = {(char)Serial.read()}; //Leer mensajes
